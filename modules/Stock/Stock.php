...
class Stock extends CRMEntity {
	...
	var $table_name = 'vtiger_stock';
	var $table_index= 'stockid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_stockcf', 'stockid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_stock', 'vtiger_stockcf');
	...
	var $popup_fields = Array('stockno');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'stockno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'stockno';
